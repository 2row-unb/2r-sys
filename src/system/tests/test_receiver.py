...
class TestReceiver:
    def test_receiver_should_get_messages(self, receiver, kernel_publish):
    ...
    def test_should_not_process_others_messages(self, receiver, kernel_publish):
        globals()['received_msg'] = None
    ...
    def test_should_process_signed_messages(self, receiver, kernel_publish):
        globals()['received_msg'] = None
